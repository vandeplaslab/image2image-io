...
def test_reduce_rgb(reduce_func):
    arrays = [np.random.default_rng().integers(0, 255, (100, 100, 3)), np.random.default_rng().integers(0, 255, (100, 100, 3))]
...
def test_reduce_grayscale(reduce_func):
    arrays = [np.random.default_rng().integers(0, 255, (100, 100)), np.random.default_rng().integers(0, 255, (100, 100))]
    result = reduce(arrays, reduce_func=reduce_func)
