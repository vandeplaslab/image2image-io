...
@click.command("crop", context_settings=ALLOW_EXTRA_ARGS)
def crop(
    image: list[str],
    output_dir: str,
    ...
    """Crop images to pyramidal OME-TIFF or OME-Zarr."""
...
def convert_runner(
    ...
    from image2image_io.crop import export_crop_regions
    ...
    for path in paths:
        export_crop_regions(path, regions=[bbox], output_dir=output_dir, tile_size=tile_size, as_uint8=as_uint8)
